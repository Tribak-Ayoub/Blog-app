    ...
    <div class="relative py-16 md:py-20 overflow-hidden bg-gradient-to-r from-blue-500 to-purple-600">
      <div class="absolute inset-0 opacity-20">
        <svg class="h-full w-full" viewBox="0 0 150 150" xmlns="http://www.w3.org/2000/svg">
          <path
            d="M-86.96 -86.96L-48.23 -48.23L-86.96 -9.51L-48.23 -48.23L-9.51 -86.96L-48.23 -48.23L-9.51 -9.51L-48.23 -48.23L-9.51 -86.96"
            stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"
            class="text-white"></path>
          <path
            d="M-86.96 28.94L-48.23 67.66L-86.96 106.38L-48.23 67.66L-9.51 28.94L-48.23 67.66L-9.51 106.38L-48.23 67.66L-9.51 28.94"
            stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"
            class="text-white"></path>
          <path
            d="M28.94 -86.96L67.66 -48.23L28.94 -9.51L67.66 -48.23L106.38 -86.96L67.66 -48.23L106.38 -9.51L67.66 -48.23L106.38 -86.96"
            stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"
            class="text-white"></path>
          <path
            d="M28.94 28.94L67.66 67.66L28.94 106.38L67.66 67.66L106.38 28.94L67.66 67.66L106.38 106.38L67.66 67.66L106.38 28.94"
            stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"
            class="text-white"></path>
        </svg>
      </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8 space-y-4 md:space-y-0">
        <div class="flex flex-col sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-4">
          ...
          <!-- Tag Filter -->
          <div class="relative">
            <select v-model="selectedTag" @change="filterArticles"
              class="appearance-none pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
        ...
        <div class="flex items-center space-x-2">
          ...
          <button @click="viewMode = 'grid'" class="p-1.5 rounded-md"
          ...
          <button @click="viewMode = 'list'" class="p-1.5 rounded-md"
      ...
      <div v-if="hasActiveFilters" class="mb-6 flex flex-wrap items-center gap-2">
        ...
        <button @click="clearAllFilters" class="text-sm text-indigo-600 hover:text-indigo-800 font-medium ml-2">
          Clear all
        </button>
      </div>
      ...
      <div v-else-if="articles.length === 0" class="text-center py-20">
        <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-12 w-12 text-gray-400" viewBox="0 0 24 24" fill="none"
        ...
        <article v-for="article in articles" :key="article.id"
          ...
          <div class="flex-shrink-0">
            <router-link :to="{ name: 'article-detail', params: { id: article.id } }" class="block">
              <img :src="article.featured_image_url || '/placeholder.jpg'" :alt="article.title"
            ...
            <div class="mt-6 flex items-center">
              <div class="flex-shrink-0">
                <img
                  ...
                  :alt="article.user ? article.user.name : 'Author'" class="h-10 w-10 rounded-full object-cover" />
              </div>
              <div class="ml-3">
      ...
      <div v-if="articles.length > 0" class="mt-12 flex justify-center">
        <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
          ...
          <template v-for="page in totalPages" :key="page">
            <button v-if="shouldShowPage(page)" @click="goToPage(page)" :class="[
            ...
            <span v-else-if="isEllipsis(page)"
