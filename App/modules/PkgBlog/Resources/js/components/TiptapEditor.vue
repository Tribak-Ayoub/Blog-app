    ...
    <div class="border border-gray-200 rounded-lg overflow-hidden">
        ...
        <div v-if="editor"
            ...
            <div class="flex items-center border-r border-gray-200 pr-1 mr-1">
                ...
                <button type="button" @click="addImage" class="p-1.5 rounded text-gray-700 hover:bg-gray-200 transition-colors"
                    title="Insert Image">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect>
                ...
                <button type="button" @click="addYoutubeVideo" class="p-1.5 rounded text-gray-700 hover:bg-gray-200 transition-colors"
            ...
            <div class="flex items-center">
                <button type="button" @click="editor.chain().focus().undo().run()" :disabled="!editor.can().undo()" :class="[
                    'p-1.5 rounded text-gray-700 hover:bg-gray-200 transition-colors',
                ...
                <button type="button" @click="editor.chain().focus().redo().run()" :disabled="!editor.can().redo()" :class="[
                    'p-1.5 rounded text-gray-700 hover:bg-gray-200 transition-colors',
