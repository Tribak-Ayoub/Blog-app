    ...
    <aside :class="[
        ...
        <div class="p-4 flex-1">
            <ul class="space-y-2">
                ...
                <li>
                    <a href="/articles" class="flex items-center p-2 hover:bg-gray-700 rounded">
                        <!-- Articles Icon -->
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <li>
                    <a href="/categories" class="flex items-center p-2 hover:bg-gray-700 rounded">
                        <!-- Categories Icon -->
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                    <a href="/tags" class="flex items-center p-2 hover:bg-gray-700 rounded">
                        <!-- Tags Icon -->
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <li>
                    <a href="/comments" class="flex items-center p-2 hover:bg-gray-700 rounded">
                        <!-- Comments Icon -->
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
